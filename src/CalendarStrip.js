...
class CalendarStrip extends Component {
  ...
  render() {
    ...
    for (let i = 0; i < datesForWeek.length; i++) {
      ...
      let calendarDay = (
        <_CalendarDay
          selectedBorderStyle={this.props.selectedBorderStyle}
          date={datesForWeek[i]}
    ...
    return (
      ...
      >
        ...
        >
          <View style={{flex:1,justifyContent:'space-between',flexDirection:'row',alignItems:'center',marginLeft:16,marginRight:16}}>
